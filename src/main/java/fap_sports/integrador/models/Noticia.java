...
public class Noticia {
    ...
    @Column(name = "not_subtitulo") // Columna para la descripción del comunicado
    ...
    @Column(name = "not_autor") // Columna para almacenar la ruta o URL de la imagen asociada al comunicado
